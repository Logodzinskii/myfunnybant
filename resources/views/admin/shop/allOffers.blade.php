        ...
        <div>
            <form method="post" action="{{url('/admin/view/offers')}}">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="Новый">
                    <label class="form-check-label" for="inlineRadio1">Новый</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="Оплата получена">
                    <label class="form-check-label" for="inlineRadio2">Оплата получена</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="Посылка отправлена">
                    <label class="form-check-label" for="inlineRadio3">Посылка отправлена</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="Покупатель отказался">
                    <label class="form-check-label" for="inlineRadio4">Покупатель отказался</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="Оплата не поступила">
                    <label class="form-check-label" for="inlineRadio4">Оплата не поступила</label>
                </div>
